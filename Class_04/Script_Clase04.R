...
ggplot(E,aes(x=AvAge,group=Sexo,colour=Sexo))+geom_density()#masculino y femenino
ggplot(E,aes(x=AvAge,group=Sexo,colour=Sexo))+geom_density()+facet_wrap(~Sexo) #ver separados con facet_wrap
...
#---- Part 3: Intro to Mapping (Shapfile, de figuras) -------------------
